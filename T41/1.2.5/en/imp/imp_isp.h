...
/**
* Target brightness meter
*/
typedef struct {
        IMPISPTuningOpsMode enable;     /** Enable target luminance meter */
        uint64_t at[15];                /** Target brightness */
} IMPISPAeAtList;

/**
* @fn int32_t IMP_ISP_Tuning_GetAeAtList(IMPVI_NUM num, IMPISPAeAtList *attr)
*
* Gets the target luminance meter
*
* @param[in] num Indicates the label of the sensor
...
* @code
* int ret = 0;
* IMPISPAeAtList attr1;
* IMP_ISP_Tuning_GetAeAtList(IMPVI_NUM,  &attr1);
* if(ret){
*		IMP_LOG_ERR(TAG, "IMP_ISP_Tuning_GetAeAtList error ! \n");
*		return -1;
*}
* @endcode
*
...
* @attention Before using this function, IMP_ISP_EnableTuning has been called.
*/
int32_t IMP_ISP_Tuning_GetAeAtList(IMPVI_NUM num, IMPISPAeAtList *attr);

/**
* Exposure gain meter
*/
typedef struct {
        IMPISPTuningOpsMode enable;     /** Exposure gain meter enabled */
        uint64_t ev[15];                /** Exposure gain meter */
} IMPISPAeEvList;

/**
* @fn int32_t IMP_ISP_Tuning_GetAEEvList(IMPVI_NUM num, IMPISPAeEvList *attr)
*
* Get exposure gain meter
*
* @param[in] num Indicates the label of the sensor
* @param[out] attr attribute
*
...
* int ret = 0;
* IMPISPevlist attr1;
* IMP_ISP_Tuning_GetAEEvList(IMPVI_NUM,  &attr1);
* if(ret){
*		IMP_LOG_ERR(TAG, "IMP_ISP_Tuning_GetAEEvList error ! \n");
*		return -1;
*}
* @endcode
*
...
* @attention Before using this function, IMP_ISP_EnableTuning has been called.
*/
int32_t IMP_ISP_Tuning_GetAEEvList(IMPVI_NUM num, IMPISPAeEvList *attr);
...
uint8_t id;              /* Curve ID */
uint16_t value[201];   /* value of the curve */
} IMPISPTmoCurve;

/**
* @fn int32_t IMP_ISP_Tuning_SetTmoCurve(IMPVI_NUM num, IMPISPTmoCurve *attr);
*
* Set the TMO curve
*
* @param[in] num corresponds to the label of the sensor
...
* int ret = 0;
* IMPISPTmoCurve attr;
* ret = IMP_ISP_Tuning_SetTmoCurve(IMPVI_MAIN,  &attr);
* if(ret){
*		IMP_LOG_ERR(TAG, "IMP_ISP_Tuning_SetTmoCurve error ! \n");
*		return -1;
*}
* @endcode
*
...
* @attentionBefore this function is used, IMP_ISP_EnableTuning is called.
*/
int32_t IMP_ISP_Tuning_SetTmoCurve(IMPVI_NUM num, IMPISPTmoCurve *attr);

/**
* @fn int32_t IMP_ISP_Tuning_GetTmoCurve(IMPVI_NUM num, IMPISPTmoCurve *attr);
*
* Get the TMO curve
*
* @param[in] num corresponds to the label of the sensor
...
* int ret = 0;
* IMPISPTmoCurve attr;
* ret = IMP_ISP_Tuning_GetTmoCurve(IMPVI_MAIN,  &attr);
* if(ret){
*		IMP_LOG_ERR(TAG, "IMP_ISP_Tuning_GetTmoCurve error ! \n");
*		return -1;
*}
* @endcode
*
...
* @attentionBefore this function is used, IMP_ISP_EnableTuning is called.
*/
int32_t IMP_ISP_Tuning_GetTmoCurve(IMPVI_NUM num, IMPISPTmoCurve *attr);
