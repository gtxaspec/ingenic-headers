 ...
 * 音频编码和解码当前音频API中支持PT_G711A、PT_G711U和PT_G726格式音频编码和解码,如需要增加新的编解码方式,需要进行注册. \n
 ...
 *
 * @param[in] s32DevId 需要进行回声抵消的音频输入设备号.
 ...
 * 启用指定音频输入的噪声抑制功能.
 *
 * @param[in] pstAttr 需要进行噪声抑制的音频属性.
 * @param[in] s32Mode 噪声抑制的级别0~3,参见 Level_ns.
 *
 * @retval 0 成功.
 * @retval 非0 失败.
 *
 ...
 * 启用音频输入的自动增益功能.
 *
 * @param[in] pstAttr 需要进行自动增益的音频属性.
 * @param[in] stAgcConfig 自动增益的参数配置,配置放大倍数.
 *
 * @retval 0 成功.
 * @retval 非0 失败.
 *
 ...
 * 启用音频输入的高通滤波.
 *
 * @param[in] pstAttr 需要进行高通滤波的音频属性.
 *
 * @retval 0 成功.
 * @retval 非0 失败.
 *
 ...
 * 设置音频输入的高通滤波器的截止频率.
 *
 * @param[in] s32Cofrequency 高通滤波的截止频率
 *
 * @retval 0 成功.
 * @retval 非0 失败.
 *
 ...
 * @param[in]  s32DevId 音频输出设备号.
 * @param[in]  s32Chn   音频输出通道号.
 * @param[out] pfGainDb  范围[-18dB ~ 28.5dB],步长1.5dB.
 * @retval 0 成功.
 * @retval 非0 失败.
 * @remarks 无.
 */
 ...
 * @param[in]  s32DevId 音频输出设备号.
 * @param[in]  s32Chn   音频输出通道号.
 * @param[out] s32Gain  音频输出增益,范围[0 ~ 0x1f],对应[-18dB ~ 28.5dB],步长1.5dB.
 *
 * @retval 0 成功.
 * @retval 非0 失败.
 *
