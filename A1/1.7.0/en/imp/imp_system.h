...
/**
 * IMP system scaler method enumeration.
 */
typedef enum{
	IMP_SCALER_METHOD_NEAR = 0, /**< Near Interpolation */
	IMP_SCALER_METHOD_BICUBIC,	/**< Bicubic Interpolation */
} IMP_SCALER_METHOD_E;
...
/**
 * @fn IMP_S32 IMP_System_SetScalerMethod(IMP_SCALER_METHOD_E enScalerMethod)
 *
 * Set IMP system scaler method.
 *
 * @param[in] enScalerMethod scaler method enumeration,default is IMP_SCALER_METHOD_BICUBIC.
 *
 * @retval IMP_SUCCESS success
 * @retval un IMP_SUCCESS failure.
 *
 * @remarks setting system parameters.
 *
 * @attention Call before IMP system initialization.
 */
IMP_S32 IMP_System_SetScalerMethod(IMP_SCALER_METHOD_E enScalerMethod);

/**
 * @fn IMP_S32 IMP_System_GetScalerMethod(IMP_SCALER_METHOD_E *penScalerMethod)
 *
 * Get IMP system scaler method.
 *
 * @param[in] penScalerMethod scaler method enumeration pointer.
 *
 * @retval IMP_SUCCESS success
 * @retval un IMP_SUCCESS failure.
 *
 ...
 * @attention NULL.
 */
IMP_S32 IMP_System_GetScalerMethod(IMP_SCALER_METHOD_E *penScalerMethod);
 ...
 * @fn IMP_S32 IMP_System_CreatPool(IMP_U32 *pu32PoolId, IMP_U32 u32BlkSize, IMP_U32 u32BlkCnt, const char *pcPoolName);
 *
 * create mempool on rmem from the tail.
 *
 * @param[in] pu32PoolId 	mempool id address.
 * @param[in] u32BlkSize	block size in mempool,unit bytes.
 * @param[in] u32BlkSize	number of blocks in mempool.
 ...
 * @attention pcPoolName cannot be null or duplicate.
 */
IMP_S32 IMP_System_CreatPool_From_Tail(IMP_U32 *pu32PoolId, IMP_U32 u32BlkSize, IMP_U32 u32BlkCnt, const char *pcPoolName);
 ...
 * @fn IMP_S32 IMP_System_CreatPool_Align(IMP_U32 *pu32PoolId, IMP_U32 u32BlkSize, IMP_U32 u32BlkCnt, const char *pcPoolName,IMP_S32 s32AlignWidth);
 *
 * Create mempool on rmem aligned from the tail.
 *
 * @param[in] pu32PoolId 	mempool id address.
 * @param[in] u32BlkSize	block size in mempool,unit bytes.
 * @param[in] u32BlkSize	number of blocks in mempool.
 ...
 * @attention pcPoolName cannot be null or duplicate.
 */
IMP_S32 IMP_System_CreatPool_Align_From_Tail(IMP_U32 *pu32PoolId, IMP_U32 u32BlkSize, IMP_U32 u32BlkCnt, const char *pcPoolName,IMP_S32 s32AlignWidth);
...
/**
 * @fn IMP_VOID *IMP_System_GetBlock_From_Tail(IMP_U32 u32PoolId, const char *pcPoolName, IMP_U32 u32Size, const char *pcBlkName);
 *
 * get block from u32PoolId or pcPoolName,and allocate memory block from the tail of rmem.
 *
 * @param[in] u32PoolId 	priority matching ID, ignore pcName if matching is successful.
 * @param[in] pcName		matching name when u32PoolId is invalid. after successful matching, allocate blocks from the pool.
 * @param[in] Size		 	block size.
 ...
 * @attention null.
 */
IMP_VOID *IMP_System_GetBlock_From_Tail(IMP_U32 u32PoolId, const char *pcPoolName, IMP_U32 u32Size, const char *pcBlkName);
...
/**
 * @fn IMP_S32 IMP_System_FlushCache_EXT(IMP_VOID *pBlockVaddr, IMP_U32 u32Size, IMP_U32 u32Dir);
 *
 * users synchronizes cache and memory data
 *
 * @param[in] pBlockVaddr	virtual address of the block
 * @param[in] u32Size		block size
 * @param[in] u32Dir		direction of cache flashing, DMA_BIDIRECTIONAL = 0 DMA_TO_DEVICE = 1 DMA_FROM_DEVICE = 2 DMA_NONE = 3
 *
 *
 * @retval IMP_SUCCESS success
 * @retval un IMP_SUCCESS failure.
 ...
 * @attention null.
 */
IMP_S32 IMP_System_FlushCache_EXT(IMP_VOID *pBlockVaddr, IMP_U32 u32Size, IMP_U32 u32Dir);
