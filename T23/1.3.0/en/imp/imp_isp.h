 ...
 *
 * Set ISP image mirror(vertical) effect function (enable/disable), direct encoding does not support this API.
 *
...
/**
 * @fn int IMP_ISP_Tuning_GetISPVflip(IMPISPTuningOpsMode *pmode), direct encoding does not support this API.
 *
 ...
 *
 * Set zone weighting for AWB, this API has been deprecated. Please call IMP_ISP_Tuning_SetAwbZoneWeight.
 *
 ...
 *
 * Get zone weighting for AWB, this API has been deprecated. Please call IMP_ISP_Tuning_GetAwbZoneWeight.
 *
 ...
 */
typedef struct {
	unsigned int weight[15][15];    /**< The weight info of each zone [0 ~ 8]*/
} IMPISPZoneWeight;

/**
 * @fn int IMP_ISP_Tuning_SetAwbZoneWeight(IMPISPZoneWeight *awb_zone_weight)
 *
 * Set zone weighting for AWB
 *
 * @param[in] awb_zone_weight awb weight.
 *
 * @retval 0 means success.
 * @retval Other values mean failure, its value is an error code.
 *
 * @attention Before using that function, make sure that ISP is working properly.
 */
int IMP_ISP_Tuning_SetAwbZoneWeight(IMPISPZoneWeight *awb_zone_weight);

/**
 * @fn int IMP_ISP_Tuning_GetAwbZoneWeight(IMPISPZoneWeight *awb_zone_weight)
 *
 * Get zone weighting for AWB
 *
 * @param[out] awb_zone_weight awb weight。
 *
 * @retval 0 means success.
 * @retval Other values mean failure, its value is an error code.
 *
 * @attention Before using that function, make sure that ISP is working properly.
 */
int IMP_ISP_Tuning_GetAwbZoneWeight(IMPISPZoneWeight *awb_zone_weight);
 ...
 */
typedef struct {
	unsigned char ae_histhresh[4];	  /**< AE Histogram threshold for bin boundary.[0 ~ 255], Write/Read*/
	unsigned short ae_hist[5];    /**< Normalized histogram results for bin.[0 ~ 65535], Only read*/
	unsigned char ae_stat_nodeh;	/**< Number of active zones horizontally for AE stats collection.[0 ~ 15], Only read*/
	unsigned char ae_stat_nodev;	/**< Number of active zones vertically for AE stats collection.[0 ~ 15], Only read*/
} IMPISPAEHist;
 ...
 *
 * Set AWB statistic parameters, this API has been deprecated.
 *
 ...
 *
 * Get AWB Statistics, this API has been deprecated.
 *
...
typedef union {
	...
	struct {
		...
		unsigned int bitBypassCSCR : 1; /* [3]  */
 ...
 *
 * Gets the associated properties of the BLC, this API is temporarily invalid.
 *
 ...
 *
 * @attention Before using this function, you must ensure that 'IMP_ISP_EnableSensor' is working.
 * @attention The implementation of this API involves zooming in first and then cropping.
 * @attention It is recommended to use the IMP_ISP_MultiCamera_Tuning_SetFrontCrop interface series to implement AutoZoom.
 */
 ...
 *
 * Get ISP image mirror(vertical) effect function (enable/disable), direct encoding does not support this API.
 *
 * @param[in] pmode The pointer for the vflip mode.
 *
 * @retval 0 means success.
 ...
 *
 * Set zone weighting for AWB, this API has been deprecated.
 *
 * @param[in] awb_weight awb weight.
 *
 * @retval 0 means success.
 ...
 *
 * Get zone weighting for AWB, this API has been deprecated.
 *
 * @param[out] awb_weight awb weight。
 *
 * @retval 0 means success.
...
/**
* @fn int32_t IMP_ISP_Tuning_SwitchBin_Sec(IMPISPBinAttr *attr)
*
* Switch the Bin file.
*
* @param[in] attr Attributes of the bin file to be switched
*
* @retval 0 successful
* @retval Non-0 failure, error code returned
* @code
...
* attr.enable = IMPISP_TUNING_OPS_MODE_ENABLE;
* memcpy(attr.bname, name, sizeof(name));
* ret = IMP_ISP_Tuning_SwitchBin_Sec( &attr);
* if(ret){
* 	IMP_LOG_ERR(TAG, "IMP_ISP_Tuning_SwitchBin_Sec error ! \n");
* 	return -1;
*}
* @endcode
*
...
/**
 * @fn int32_t IMP_ISP_MultiCamera_SetDefaultBinPath(IMPVI_NUM num, char *path)
 *
 * Sets the default path to the ISP bin file.
 *
 * @param[in] num   the sensor num label.
 * @param[out] path	The bin file path property to set.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 ...
 * @attention Only bin file path attributes for a single ISP can be retrieved at a time.
 */
int32_t IMP_ISP_MultiCamera_SetDefaultBinPath(IMPVI_NUM num, char *path);

/**
 * @fn int32_t IMP_ISP_MultiCamera_GetDefaultBinPath(IMPVI_NUM num, char *path)
 *
 * Gets the default path to the ISP bin file.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Only bin file path attributes for a single ISP can be retrieved at a time.
 */
int32_t IMP_ISP_MultiCamera_GetDefaultBinPath(IMPVI_NUM num, char *path);

/**
 * @fn int IMP_ISP_MultiCamera_SetSensorRegister(IMPVI_NUM num, uint32_t reg, uint32_t value)
 *
 * Set the value of a register of a sensor.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using this function, you must ensure that the sensor is working.
 */
int IMP_ISP_MultiCamera_SetSensorRegister(IMPVI_NUM num, uint32_t reg, uint32_t value);

/**
 * @fn int IMP_ISP_MultiCamera_GetSensorRegister(IMPVI_NUM num, uint32_t reg, uint32_t *value)
 *
 * Obtain a value of the register of sensor.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using this function, you must ensure that the sensor is working.
 */
int IMP_ISP_MultiCamera_GetSensorRegister(IMPVI_NUM num, uint32_t reg, uint32_t *value);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetSensorFPS(IMPVI_NUM num, uint32_t fps_num, uint32_t fps_den)
 *
 * Set the FPS of enabled sensor.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using this function, make sure that 'IMP_ISP_EnableSensor' and 'IMP_ISP_EnableTuning' are working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetSensorFPS(IMPVI_NUM num, uint32_t fps_num, uint32_t fps_den);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetSensorFPS(IMPVI_NUM num, uint32_t *fps_num, uint32_t *fps_den)
 *
 * Get the FPS of enabled sensor.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before starting data transmission in a Channel, you must first call this function in order to obtain the sensor's default FPS.
 */
int IMP_ISP_MultiCamera_Tuning_GetSensorFPS(IMPVI_NUM num, uint32_t *fps_num, uint32_t *fps_den);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAntiFlickerAttr(IMPVI_NUM num, IMPISPAntiflickerAttr attr)
 *
 * Set the antiflicker parameter.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_SetAntiFlickerAttr(IMPVI_NUM num, IMPISPAntiflickerAttr attr);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAntiFlickerAttr(IMPVI_NUM num, IMPISPAntiflickerAttr *pattr)
 *
 * Get the mode of antiflicker
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_GetAntiFlickerAttr(IMPVI_NUM num, IMPISPAntiflickerAttr *pattr);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetBrightness(IMPVI_NUM num, unsigned char bright)
 *
 * Set the brightness of image effect.
 *
 * @param[in] num   the sensor num label.
...
/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetBrightness(IMPVI_NUM num, unsigned char *pbright)
 *
 * Get the brightness of image effect.
 *
 * @param[in] num   the sensor num label.
 * @param[in] bright The pointer for brightness value.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
...
/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetContrast(IMPVI_NUM num, unsigned char contrast)
 *
 * Set the contrast of image effect.
 *
 * @param[in] num      the sensor num label.
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_SetContrast(IMPVI_NUM num, unsigned char contrast);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetContrast(IMPVI_NUM num, unsigned char *pcontrast)
 *
 * Get the contrast of image effect.
 *
 * @param[in] num      the sensor num label.
 * @param[in] contrast The pointer for contrast.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_GetContrast(IMPVI_NUM num, unsigned char *pcontrast);

 /**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetSharpness(IMPVI_NUM num, unsigned char sharpness)
 *
 *  Set the sharpness of image effect.
 *
 * @param[in] num       the sensor num label.
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_SetSharpness(IMPVI_NUM num, unsigned char sharpness);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetSharpness(IMPVI_NUM num, unsigned char *psharpness)
 *
 * Get the sharpness of image effect.
 *
 * @param[in] num       the sensor num label.
 * @param[in] sharpness The pointer for sharpness strength.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_GetSharpness(IMPVI_NUM num, unsigned char *psharpness);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetBcshHue(IMPVI_NUM num, unsigned char hue)
 *
 * Set the hue of image color.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_SetBcshHue(IMPVI_NUM num, unsigned char hue);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetBcshHue(IMPVI_NUM num, unsigned char *hue)
 *
 * Get the hue of image color.
 *
 * @param[in] num   the sensor num label.
 * @param[out] hue  The pointer for hue value.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_GetBcshHue(IMPVI_NUM num, unsigned char *hue);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetSaturation(IMPVI_NUM num, unsigned char sat)
 *
 * Set the saturation of image effect.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_SetSaturation(IMPVI_NUM num, unsigned char sat);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetSaturation(IMPVI_NUM num, unsigned char *psat)
 *
 * Get the saturation of image effect.
 *
 * @param[in] num   the sensor num label.
 * @param[in] sat   The pointer for saturation strength.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_GetSaturation(IMPVI_NUM num, unsigned char *psat);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetTotalGain(IMPVI_NUM num, uint32_t *gain)
 *
 * Get the overall gain value of the ISP output image
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using this function, make sure that 'IMP_ISP_EnableSensor' and 'IMP_ISP_EnableTuning' are working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetTotalGain(IMPVI_NUM num, uint32_t *gain);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetISPHflip(IMPVI_NUM num, IMPISPTuningOpsMode mode)
 *
 * Set ISP image mirror(horizontal) effect function (enable/disable)
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetISPHflip(IMPVI_NUM num, IMPISPTuningOpsMode mode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetISPHflip(IMPVI_NUM num, IMPISPTuningOpsMode *pmode)
 *
 * Get ISP image mirror(horizontal) effect function (enable/disable)
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetISPHflip(IMPVI_NUM num, IMPISPTuningOpsMode *pmode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetISPVflip(IMPVI_NUM num, IMPISPTuningOpsMode mode)
 *
 * Set ISP image mirror(vertical) effect function (enable/disable),direct encoding does not support this API.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetISPVflip(IMPVI_NUM num, IMPISPTuningOpsMode mode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetISPVflip(IMPVI_NUM num, IMPISPTuningOpsMode *pmode)
 *
 * Get ISP image mirror(vertical) effect function (enable/disable),direct encoding does not support this API.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetISPVflip(IMPVI_NUM num, IMPISPTuningOpsMode *pmode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetSensorHflip(IMPVI_NUM num, IMPISPTuningOpsMode mode)
 *
 * Set Sensor image mirror(horizontal) effect function (enable/disable)
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetSensorHflip(IMPVI_NUM num, IMPISPTuningOpsMode mode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetSensorHflip(IMPVI_NUM num, IMPISPTuningOpsMode *pmode)
 *
 * Get Sensor image mirror(horizontal) effect function (enable/disable)
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetSensorHflip(IMPVI_NUM num, IMPISPTuningOpsMode *pmode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetSensorVflip(IMPVI_NUM num, IMPISPTuningOpsMode mode)
 *
 * Set Sensor image mirror(vertical) effect function (enable/disable)
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetSensorVflip(IMPVI_NUM num, IMPISPTuningOpsMode mode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetSensorVflip(IMPVI_NUM num, IMPISPTuningOpsMode *pmode)
 *
 * Get Sensor image mirror(vertical) effect function (enable/disable)
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetSensorVflip(IMPVI_NUM num, IMPISPTuningOpsMode *pmode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetISPRunningMode(IMPVI_NUM num, IMPISPRunningMode mode)
 *
 * Set ISP running mode, normal mode or night vision mode; default mode: normal mode.
 *
 * @param[in] num   the sensor num label.
 ...
 * IMPISPRunningMode mode;
 *
 *	if(IMPVI_NUM num,  it is during a night now){
		mode = IMPISP_RUNNING_MODE_NIGHT
	}else{
		mode = IMPISP_RUNNING_MODE_DAY;
	}
	ret = IMP_ISP_MultiCamera_Tuning_SetISPRunningMode(IMPVI_NUM num, mode);
	if(IMPVI_NUM num, ret){
		IMP_LOG_ERR(IMPVI_NUM num, TAG, "IMP_ISP_MultiCamera_Tuning_SetISPRunningMode error !\n");
		return -1;
	}
 *
 * @endcode
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetISPRunningMode(IMPVI_NUM num, IMPISPRunningMode mode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetISPRunningMode(IMPVI_NUM num, IMPISPRunningMode *pmode)
 *
 * Get ISP running mode, normal mode or night vision mode;
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetISPRunningMode(IMPVI_NUM num, IMPISPRunningMode *pmode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetISPCustomMode(IMPVI_NUM num, IMPISPTuningOpsMode mode)
 *
 * Enable ISP custom mode, load another set of parameters.
 *
 * @param[in] num   the sensor num label.
...
int IMP_ISP_MultiCamera_Tuning_SetISPCustomMode(IMPVI_NUM num, IMPISPTuningOpsMode mode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetISPCustomMode(IMPVI_NUM num, IMPISPTuningOpsMode mode)
 *
 * get ISP custom mode
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetISPCustomMode(IMPVI_NUM num, IMPISPTuningOpsMode *pmode);

/**
* @fn int IMP_ISP_MultiCamera_Tuning_SetGamma(IMPVI_NUM num, IMPISPGamma *gamma)
*
* Sets the attributes of ISP gamma..
*
* @param[in] num   the sensor num label.
...
* @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
*/
int IMP_ISP_MultiCamera_Tuning_SetGamma(IMPVI_NUM num, IMPISPGamma *gamma);

/**
* @fn int IMP_ISP_MultiCamera_Tuning_GetGamma(IMPVI_NUM num, IMPISPGamma *gamma)
*
* Obtains the attributes of gamma.
*
* @param[in] num   the sensor num label.
...
* @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
*/
int IMP_ISP_MultiCamera_Tuning_GetGamma(IMPVI_NUM num, IMPISPGamma *gamma);

/**
* @fn int IMP_ISP_MultiCamera_Tuning_SetAeComp(IMPVI_NUM num, int comp)
*
* Setting AE compensation.AE compensation parameters can adjust the target of the image AE.
* the recommended value range is from 0 to 255.
*
...
* @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
*/
int IMP_ISP_MultiCamera_Tuning_SetAeComp(IMPVI_NUM num, int comp);

/**
* @fn int IMP_ISP_MultiCamera_Tuning_GetAeComp(IMPVI_NUM num, int *comp)
*
* Obtains the compensation of AE.
*
* @param[in] num   the sensor num label.
...
* @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
*/
int IMP_ISP_MultiCamera_Tuning_GetAeComp(IMPVI_NUM num, int *comp);

/**
* @fn int IMP_ISP_MultiCamera_Tuning_GetAeLuma(IMPVI_NUM num, int *luma)
*
* Obtains the AE luma of current frame.
*
* @param[in] num   the sensor num label.
...
* @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
*/
int IMP_ISP_MultiCamera_Tuning_GetAeLuma(IMPVI_NUM num, int *luma);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAeFreeze(IMPVI_NUM num, IMPISPTuningOpsMode mode)
 *
 * AE Freeze.
 *
 * @param[in] num   the sensor num label.
...
int IMP_ISP_MultiCamera_Tuning_SetAeFreeze(IMPVI_NUM num, IMPISPTuningOpsMode mode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetExpr(IMPVI_NUM num, IMPISPExpr *expr)
 *
 * Set AE attributes.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetExpr(IMPVI_NUM num, IMPISPExpr *expr);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetExpr(IMPVI_NUM num, IMPISPExpr *expr)
 *
 * Get AE attributes.
 *
 * @param[in] num   the sensor num label.
 * @param[out] expr The pointer for exposure attributes.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetExpr(IMPVI_NUM num, IMPISPExpr *expr);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetWB(IMPVI_NUM num, IMPISPWB *wb)
 *
 * Set the white balance function settings. You can set the automatic and manual mode, manual mode is achieved mainly through setting of bgain, rgain.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetWB(IMPVI_NUM num, IMPISPWB *wb);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetWB(IMPVI_NUM num, IMPISPWB *wb)
 *
 * Get the white balance function settings
 *
 * @param[in] num   the sensor num label.
 * @param[out] wb   The pointer for WB attribute.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetWB(IMPVI_NUM num, IMPISPWB *wb);

/**
 * @fn IMP_ISP_MultiCamera_Tuning_GetWB_Statis(IMPVI_NUM num, IMPISPWB *wb)
 *
 * Get the white balance statistic value.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetWB_Statis(IMPVI_NUM num, IMPISPWB *wb);

/**
 * @fn IMP_ISP_MultiCamera_Tuning_GetWB_GOL_Statis(IMPVI_NUM num, IMPISPWB *wb)
 *
 * Get the white balance global statistic value.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetWB_GOL_Statis(IMPVI_NUM num, IMPISPWB *wb);

/**
 * int IMP_ISP_MultiCamera_Tuning_SetAwbClust(IMPVI_NUM num, IMPISPAWBCluster *awb_cluster);
 *
 * Set Cluster AWB mode Parameters.
 *
 * @param[in] num     the sensor num label.
 * @param[in] CLuster contains cluster awb mode parameters
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
...
/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAwbClust(IMPVI_NUM num, IMPISPAWBCluster *awb_cluster)
 *
 * Get Cluster AWB mode Parameters.
 *
 * @param[in] num      the sensor num label.
 * @param[out] CLuster contains cluster awb mode parameters
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAwbClust(IMPVI_NUM num, IMPISPAWBCluster *awb_cluster);

/**
 * int IMP_ISP_MultiCamera_Tuning_SetAwbCtTrend(IMPVI_NUM num, IMPISPAWBCtTrend *ct_trend);
 *
 * Set rg bg offset under different ct.
 *
 * @param[in] num      the sensor num label.
...
/**
 * int IMP_ISP_MultiCamera_Tuning_GetAwbCtTrend(IMPVI_NUM num, IMPISPAWBCtTrend *ct_trend);
 *
 * Get rg bg offset under different ct.
 *
 * @param[in] num       the sensor num label.
...
/**
 * @fn IMP_ISP_MultiCamera_Tuning_Awb_GetRgbCoefft(IMPVI_NUM num, IMPISPCOEFFTWB *isp_core_rgb_coefft_wb_attr)
 *
 * Get the AWB r g b channel offset source in ISP.
 *
 * @param[in] num   the sensor num label.
 * @param[in] isp_core_rgb_coefft_wb_attr    The pointer for the attributes
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_Awb_GetRgbCoefft(IMPVI_NUM num, IMPISPCOEFFTWB *isp_core_rgb_coefft_wb_attr);

/**
 * @fn IMP_ISP_MultiCamera_Tuning_Awb_SetRgbCoefft(IMPVI_NUM num, IMPISPCOEFFTWB *isp_core_rgb_coefft_wb_attr)
 *
 * Sets the Max value of sensor color r g b.
 *
 * @param[in] num   the sensor num label.
 * @param[out] isp_core_rgb_coefft_wb_attr  The value for sensor sensor color r g b..
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 ...
 *isp_core_rgb_coefft_wb_attr.rgb_coefft_wb_g=y;
 *isp_core_rgb_coefft_wb_attr.rgb_coefft_wb_b=z;
 *IMP_ISP_MultiCamera_Tuning_Awb_SetRgbCoefft(IMPVI_NUM num, &isp_core_rgb_coefft_wb_attr);
 if(IMPVI_NUM num, ret){
 IMP_LOG_ERR(IMPVI_NUM num, TAG, "IMP_ISP_MultiCamera_Tuning_Awb_SetRgbCoefft error !\n");
 return -1;
 }
*/
int IMP_ISP_MultiCamera_Tuning_Awb_SetRgbCoefft(IMPVI_NUM num, IMPISPCOEFFTWB *isp_core_rgb_coefft_wb_attr);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetMaxAgain(IMPVI_NUM num, uint32_t gain)
 *
 * Sets the Max value of sensor analog gain.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetMaxAgain(IMPVI_NUM num, uint32_t gain);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetMaxAgain(IMPVI_NUM num, uint32_t *gain)
 *
 * Get the Max value of sensor analog gain.
 *
 * @param[in] num   the sensor num label.
 * @param[out] gain The pointer for sensor analog gain.
 * The value of 0 corresponds to 1x gain, 32 corresponds to 2x gain and so on.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetMaxAgain(IMPVI_NUM num, uint32_t *gain);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetMaxDgain(IMPVI_NUM num, uint32_t gain)
 *
 * Set the Max value of sensor Digital gain.
 *
 * @param[in] num    the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetMaxDgain(IMPVI_NUM num, uint32_t gain);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetMaxDgain(IMPVI_NUM num, uint32_t *gain)
 *
 * Get the Max value of sensor Digital gain.
 *
 * @param[in] num     the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetMaxDgain(IMPVI_NUM num, uint32_t *gain);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetHiLightDepress(IMPVI_NUM num, uint32_t strength)
 *
 * Set highlight intensity controls.
 *
 * @param[in] num      the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetHiLightDepress(IMPVI_NUM num, uint32_t strength);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetHiLightDepress(IMPVI_NUM num, uint32_t *strength)
 *
 * Get the strength of high light depress.
 *
 * @param[in] num       the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetHiLightDepress(IMPVI_NUM num, uint32_t *strength);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetBacklightComp(IMPVI_NUM num, uint32_t strength)
 *
 * Set backlight intensity controls.
 *
 * @param[in] num      the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetBacklightComp(IMPVI_NUM num, uint32_t strength);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetBacklightComp(IMPVI_NUM num, uint32_t *strength)
 *
 * Get the strength of backlight compensation.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetBacklightComp(IMPVI_NUM num, uint32_t *strength);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetTemperStrength(IMPVI_NUM num, uint32_t ratio)
 *
 * Set 3D noise reduction intensity
 *
 * @param[in] num   the sensor num label.
 * @param[in] ratio Intensity modulation ratio. Default value is 128.If it is greater than 128, that means increaseing the temper value.
 * If it is less than 128, that means decreaing the temper value. The value range is [0-255].
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetTemperStrength(IMPVI_NUM num, uint32_t ratio);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetSinterStrength(IMPVI_NUM num, uint32_t ratio)
 *
 * Set 2D noise reduction intensity
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetSinterStrength(IMPVI_NUM num, uint32_t ratio);

/**
* @fn int IMP_ISP_MultiCamera_Tuning_GetEVAttr(IMPVI_NUM num, IMPISPEVAttr *attr)
*
* Obtains the attributes of exposure value.
*
* @param[in] num   the sensor num label.
...
* @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
*/
int IMP_ISP_MultiCamera_Tuning_GetEVAttr(IMPVI_NUM num, IMPISPEVAttr *attr);

/**
* @fn int IMP_ISP_MultiCamera_Tuning_EnableMovestate(IMPVI_NUM num)
*
* When the sensor will motion, it should be called.
*
* @param[in] num   the sensor num label.
...
* @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
*/
int IMP_ISP_MultiCamera_Tuning_EnableMovestate(IMPVI_NUM num);

/**
* @fn int IMP_ISP_MultiCamera_Tuning_DisableMovestate(IMPVI_NUM num)
*
* When the sensor is from motion to still, it should be called.
*
* @param[in] num   the sensor num label.
...
* @attention Before using it, make sure that 'IMP_ISP_Tuning_EnableMovestate' is working properly.
*/
int IMP_ISP_MultiCamera_Tuning_DisableMovestate(IMPVI_NUM num);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAeWeight(IMPVI_NUM num, IMPISPWeight *ae_weight)
 *
 * Set zone weighting for AE target
 *
 * @param[in] num       the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAeWeight(IMPVI_NUM num, IMPISPWeight *ae_weight);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAeWeight(IMPVI_NUM num, IMPISPWeight *ae_weight)
 *
 * Get zone weighting for AE target
 *
 * @param[in] num        the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAeWeight(IMPVI_NUM num, IMPISPWeight *ae_weight);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_AE_GetROI(IMPVI_NUM num, IMPISPWeight *roi_weight)
 *
 * Set roi weighting for AE SCENE judgement
 *
 * @param[in] num         the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_AE_GetROI(IMPVI_NUM num, IMPISPWeight *roi_weight);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_AE_SetROI(IMPVI_NUM num, IMPISPWeight *roi_weight)
 *
 * Get roi weighting for AE SCENE judgement
 *
 * @param[in] num        the sensor num label.
 * @param[in] roi_weight aexp weight.
 *
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_AE_SetROI(IMPVI_NUM num, IMPISPWeight *roi_weight);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAwbWeight(IMPVI_NUM num, IMPISPWeight *awb_weight)
 *
 * Set zone weighting for AWB, this API has been deprecated. Please call IMP_ISP_MultiCamera_Tuning_SetAwbZoneWeight.
 *
 * @param[in] num        the sensor num label.
 * @param[in] awb_weight awb weight.
 *
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAwbWeight(IMPVI_NUM num, IMPISPWeight *awb_weight);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAwbWeight(IMPVI_NUM num, IMPISPWeight *awb_weight)
 *
 * Get zone weighting for AWB, this API has been deprecated. Please call IMP_ISP_MultiCamera_Tuning_GetAwbZoneWeight.
 *
 * @param[in] num   the sensor num label.
 * @param[out] awb_weight awb weight.
 *
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAwbWeight(IMPVI_NUM num, IMPISPWeight *awb_weight);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAwbZoneWeight(IMPVI_NUM num, IMPISPZoneWeight *awb_zone_weight)
 *
 * Set zone weighting for AWB.
 *
 * @param[in] num   the sensor num label.
 * @param[in] awb_zone_weight awb zone weight
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAwbZoneWeight(IMPVI_NUM num, IMPISPZoneWeight *awb_zone_weight);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAwbZoneWeight(IMPVI_NUM num, IMPISPZoneWeight *awb_zone_weight)
 *
 * Get zone weighting for AWB.
 *
 * @param[in] num   the sensor num label.
 * @param[out] awb_zone_weight awb zone weight
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAwbZoneWeight(IMPVI_NUM num, IMPISPZoneWeight *awb_zone_weight);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAwbZone(IMPVI_NUM num, IMPISPAWBZONE *awb_zone)
 *
 * Get WB zone statistical average in R G B channel
 *
 * @param[out] awb_zone wb statistics。
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAwbZone(IMPVI_NUM num, IMPISPAWBZone *awb_zone);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetWB_ALGO(IMPVI_NUM num, IMPISPAWBALGO wb_algo)
 *
 * Set AWB algorithm for different application situation
 *
 * @param[in] num     the sensor num label.
 * @param[in] wb_algo algorithm
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
...
int IMP_ISP_MultiCamera_Tuning_SetWB_ALGO(IMPVI_NUM num, IMPISPAWBAlgo wb_algo);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAeHist(IMPVI_NUM num, IMPISPAEHist *ae_hist)
 *
 * Set AE statistics parameters
 *
 * @param[in] num     the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAeHist(IMPVI_NUM num, IMPISPAEHist *ae_hist);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAeHist(IMPVI_NUM num, IMPISPAEHist *ae_hist)
 *
 * Get AE statistics information.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAeHist(IMPVI_NUM num, IMPISPAEHist *ae_hist);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAeHist_Origin(IMPVI_NUM num, IMPISPAEHistOrigin *ae_hist)
 *
 * Get AE 256 bin statistics information.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAeHist_Origin(IMPVI_NUM num, IMPISPAEHistOrigin *ae_hist);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAwbHist(IMPVI_NUM num, IMPISPAWBHist *awb_hist)
 *
 * Get AWB Statistics, this API has been deprecated.
 *
 * @param[in] num       the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAwbHist(IMPVI_NUM num, IMPISPAWBHist *awb_hist);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAwbHist(IMPVI_NUM num, IMPISPAWBHist *awb_hist)
 *
 * Set AWB statistic parameters, this API has been deprecated.
 *
 * @param[in] num      the sensor num label.
 * @param[in] awb_hist AWB statistic
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAwbHist(IMPVI_NUM num, IMPISPAWBHist *awb_hist);

/**
 * @fn IMP_ISP_MultiCamera_Tuning_GetAFMetrices(IMPVI_NUM num, unsigned int *metric);
 *
 * Get AF statistic metric
 *
 * @param[in] num     the sensor num label.
 * @param[out] metric AF statistic parameters
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAFMetrices(IMPVI_NUM num, unsigned int *metric);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAfHist(IMPVI_NUM num, IMPISPAFHist *af_hist);
 *
 * Get AF statistic parameters
 *
 * @param[in] num      the sensor num label.
 * @param[out] af_hist AF statistics parameters
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAfHist(IMPVI_NUM num, IMPISPAFHist *af_hist);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAfHist(IMPVI_NUM num, IMPISPAFHist *af_hist)
 *
 * Set AF statistic parameters
 *
 * @param[in] num     the sensor num label.
 * @param[in] af_hist af weight.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAfHist(IMPVI_NUM num, IMPISPAFHist *af_hist);
/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAfWeight(IMPVI_NUM num, IMPISPWeight *af_weight)
 *
 * Set zone weighting for AF
 *
 * @param[in] num       the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAfWeight(IMPVI_NUM num, IMPISPWeight *af_weight);
/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAfWeight(IMPVI_NUM num, IMPISPWeight *af_weight)
 *
 * Get zone weighting for AF
 *
 * @param[in] num        the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAfWeight(IMPVI_NUM num, IMPISPWeight *af_weight);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAfZone(IMPVI_NUM num, IMPISPZone *af_zone)
 *
 * Get AF zone metric information.
 *
 * @param[in] num      the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAfZone(IMPVI_NUM num, IMPISPZone *af_zone);

/**
* @fn int IMP_ISP_MultiCamera_Tuning_WaitFrame(IMPVI_NUM num, IMPISPWaitFrameAttr *attr)
*  Wait frame done
*
 * @param[in] num   the sensor num label.
* @param[out] attr  frame done parameters
...
* @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
*/
int IMP_ISP_MultiCamera_Tuning_WaitFrame(IMPVI_NUM num, IMPISPWaitFrameAttr *attr);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAeMin(IMPVI_NUM num, IMPISPAEMin *ae_min)
 *
 * Set AE Min parameters
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAeMin(IMPVI_NUM num, IMPISPAEMin *ae_min);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAeMin(IMPVI_NUM num, IMPISPAEMin *ae_min)
 *
 * Get AE min information.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAeMin(IMPVI_NUM num, IMPISPAEMin *ae_min);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAe_IT_MAX(IMPVI_NUM num, unsigned int it_max)
 *
 * Set AE Max parameters
 *
 * @param[in] num    the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAe_IT_MAX(IMPVI_NUM num, unsigned int it_max);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAE_IT_MAX(IMPVI_NUM num, unsigned int *it_max)
 *
 * Get AE max information.
 *
 * @param[in] num     the sensor num label.
 * @param[out] it_max AE max it parameters
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAE_IT_MAX(IMPVI_NUM num, unsigned int *it_max);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAeZone(IMPVI_NUM num, IMPISPZone *ae_zone)
 *
 *  Get AE zone y information.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAeZone(IMPVI_NUM num, IMPISPZone *ae_zone);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAeTargetList(IMPVI_NUM num, IMPISPAETargetList *target_list)
 *
 * Set  AE target List
 *
 * @param[in] num   the sensor num label.
 * @param[in] target_list  ae target list.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using that function, make sure that ISP is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAeTargetList(IMPVI_NUM num, IMPISPAETargetList *target_list);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAeTargetList(IMPVI_NUM num, IMPISPAETargetList *target_list)
 *
 * Get  AE target List.
 *
 * @param[in] num   the sensor num label.
 * @param[out] target_list  ae target list.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using that function, make sure that ISP is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAeTargetList(IMPVI_NUM num, IMPISPAETargetList *target_list);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetModuleControl(IMPVI_NUM num, IMPISPModuleCtl *ispmodule)
 *
 * Set ISP Module control.
 *
 * @param[in] num       the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetModuleControl(IMPVI_NUM num, IMPISPModuleCtl *ispmodule);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetModuleControl(IMPVI_NUM num, IMPISPModuleCtl *ispmodule)
 *
 * Get ISP Module control.
 *
 * @param[in] num        the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetModuleControl(IMPVI_NUM num, IMPISPModuleCtl *ispmodule);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetFrontCrop(IMPVI_NUM num, IMPISPFrontCrop *ispfrontcrop)
 *
 * Set Front Crop attribution.
 *
 * @param[in] num          the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetFrontCrop(IMPVI_NUM num, IMPISPFrontCrop *ispfrontcrop);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetFrontCrop(IMPVI_NUM num, IMPISPFrontCrop *ispfrontcrop)
 *
 * Get Front Crop Attribution.
 *
 * @param[in] num           the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetFrontCrop(IMPVI_NUM num, IMPISPFrontCrop *ispfrontcrop);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetDPC_Strength(IMPVI_NUM num, unsigned int strength)
 *
 * Set DPC Strength.
 *
 * @param[in] num      the sensor num label.
 * @param[in] strength Intensity modulation ratio. Default value is 128.If it is greater than 128, that means increaseing the dpc value.
 * If it is less than 128, that means decreaing the dpc value. The value range is [0-255].
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetDPC_Strength(IMPVI_NUM num, unsigned int ratio);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetDPC_Strength(IMPVI_NUM num, unsigned int *strength)
 *
 * Get DPC Strength.
 *
 * @param[in] num       the sensor num label.
 * @param[out] strength Intensity modulation ratio. Default value is 128.If it is greater than 128, that means increaseing the dpc value.
 * If it is less than 128, that means decreaing the dpc value. The value range is [0-255].
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetDPC_Strength(IMPVI_NUM num, unsigned int *ratio);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetDRC_Strength(IMPVI_NUM num, unsigned int ratio)
 *
 * Set DRC Strength.
 *
 * @param[in] num      the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetDRC_Strength(IMPVI_NUM num, unsigned int ratio);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetDRC_Strength(IMPVI_NUM num, unsigned int *ratio)
 *
 * Get DRC Strength.
 *
 * @param[in] num    the sensor num label.
 * @param[out] ratio Intensity modulation ratio. Default value is 128.If it is greater than 128, that means increaseing the dpc value.
 * If it is less than 128, that means decreaing the dpc value. The value range is [0-255].
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetDRC_Strength(IMPVI_NUM num, unsigned int *ratio);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetHVFLIP(IMPVI_NUM num, IMPISPHVFLIP hvflip)
 *
 * Set HV Flip mode.
 *
 * @param[in] num    the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetHVFLIP(IMPVI_NUM num, IMPISPHVFLIP hvflip);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetHVFlip(IMPVI_NUM num, IMPISPHVFLIP *hvflip)
 *
 * Get HV Flip mode.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetHVFlip(IMPVI_NUM num, IMPISPHVFLIP *hvflip);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetMask(IMPVI_NUM num, IMPISPMASKAttr *mask)
 *
 * Set Mask Attr.
 *
 * @param[in] num  the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetMask(IMPVI_NUM num, IMPISPMASKAttr *mask);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetMask(IMPVI_NUM num, IMPISPMASKAttr *mask)
 *
 * Get Mask Attr..
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetMask(IMPVI_NUM num, IMPISPMASKAttr *mask);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetSensorAttr(IMPVI_NUM num, IMPISPSENSORAttr *attr)
 *
 * Get Sensor Attr.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetSensorAttr(IMPVI_NUM num, IMPISPSENSORAttr *attr);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_EnableDRC(IMPVI_NUM num, IMPISPTuningOpsMode mode)
 *
 * Enable DRC..
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_EnableDRC(IMPVI_NUM num, IMPISPTuningOpsMode mode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_EnableDefog(IMPVI_NUM num, IMPISPTuningOpsMode mode)
 *
 * Enable Defog..
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_EnableDefog(IMPVI_NUM num, IMPISPTuningOpsMode mode);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAwbCt(IMPVI_NUM num, unsigned int *ct)
 *
 * set awb color temp..
 *
 * @param[in] num   the sensor num label.
 * @param[in] ct    AWB color temp value..
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAwbCt(IMPVI_NUM num, unsigned int *ct);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAWBCt(IMPVI_NUM num, unsigned int *ct)
 *
 * Get AWB color temp..
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAWBCt(IMPVI_NUM num, unsigned int *ct);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetCCMAttr(IMPVI_NUM num, IMPISPCCMAttr *ccm)
 *
 * set ccm attr.
 *
 * @param[in] num   the sensor num label.
 * @param[in] ccm   ccm attr..
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetCCMAttr(IMPVI_NUM num, IMPISPCCMAttr *ccm);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetCCMAttr(IMPVI_NUM num, IMPISPCCMAttr *ccm)
 *
 * Get CCM Attr..
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetCCMAttr(IMPVI_NUM num, IMPISPCCMAttr *ccm);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAeAttr(IMPVI_NUM num, IMPISPAEAttr *ae)
 *
 * set Ae attr.
 *
 * @param[in] num   the sensor num label.
 * @param[in] ae    ae manual attr.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_SetAeAttr(IMPVI_NUM num, IMPISPAEAttr *ae);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAeAttr(IMPVI_NUM num, IMPISPAEAttr *ae)
 *
 * Get Ae Attr..
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before set the attr, you must memset the IMPISPAEAttr structure to 0, and then set the corresponding attr.
 */
int IMP_ISP_MultiCamera_Tuning_GetAeAttr(IMPVI_NUM num, IMPISPAEAttr *ae);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetAeState(IMPVI_NUM num, IMPISPAEState *ae_state)
 *
 * Get Ae Attr..
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int IMP_ISP_MultiCamera_Tuning_GetAeState(IMPVI_NUM num, IMPISPAEState *ae_state);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetScalerLv(IMPVI_NUM num, IMPISPScalerLv *scaler_level)
 *
 * Set Scaler method and level.
 *
 * @param[in] num     the sensor num label.
 ...
 * @attention Before calling this function, make sure that ISP debugging function is working.
 */
int IMP_ISP_MultiCamera_Tuning_SetScalerLv(IMPVI_NUM num, IMPISPScalerLv *scaler_level);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_GetBlcAttr(IMPVI_NUM num, IMPISPBlcAttr *blc)
 *
 * Gets the associated properties of the BLC, this API is temporarily invalid.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before set the attr, you must memset the IMPISPAEAttr structure to 0.
 */
int IMP_ISP_MultiCamera_Tuning_GetBlcAttr(IMPVI_NUM num, IMPISPBlcAttr *blc);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_SetDefog_Strength(IMPVI_NUM num, uint8_t *ratio)
 *
 * set isp defog module ratio.
 *
 * @param[in] num    the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_SetDefog_Strength(IMPVI_NUM num, uint8_t *ratio);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_GetDefog_Strength(IMPVI_NUM num, uint8_t *ratio)
 *
 * get isp defog module ratio.
 *
 * @param[in] num    the sensor num label.
 * @param[in] ratio  defog module ratio.
 *
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_GetDefog_Strength(IMPVI_NUM num, uint8_t *ratio);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_SetCsc_Attr(IMPVI_NUM num, IMPISPCscAttr *attr)
 *
 * Set the properties of CSC module.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_SetCsc_Attr(IMPVI_NUM num, IMPISPCscAttr *attr);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_GetCsc_Attr(IMPVI_NUM num, IMPISPCscAttr *attr)
 *
 * Get the properties of CSC module.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_GetCsc_Attr(IMPVI_NUM num, IMPISPCscAttr *attr);

/**
 * @fn int32_t IMP_ISP_MultiCamera_SetFrameDrop(IMPVI_NUM num, IMPISPFrameDropAttr *attr)
 *
 * Set frame drop attr.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_Open' is working properly.
 */
int32_t IMP_ISP_MultiCamera_SetFrameDrop(IMPVI_NUM num, IMPISPFrameDropAttr *attr);

/**
 * @fn int32_t IMP_ISP_MultiCamera_GetFrameDrop(IMPVI_NUM num, IMPISPFrameDropAttr *attr)
 *
 *Get frame drop attr.
 *
 * @param[in] num    the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_Open' is working properly.
 */
int32_t IMP_ISP_MultiCamera_GetFrameDrop(IMPVI_NUM num, IMPISPFrameDropAttr *attr);

/**
 * @fn int32_t IMP_ISP_MultiCamera_SetFixedContraster(IMPVI_NUM num, IMPISPFixedContrastAttr *attr)
 *
 * set mjpeg fixed contrast.
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_SetFixedContraster(IMPVI_NUM num, IMPISPFixedContrastAttr *attr);

/**
 * @fn int IMP_ISP_MultiCamera_Tuning_SetAutoZoom(IMPVI_NUM num, IMPISPAutoZoom *ispautozoom)
 *
 * Set AutoZoom Parameters
 *
 * @param[in] num         the sensor num label.
 * @param[in] ispautozoom Parameters
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 ...
 * @attention It is recommended to use the IMP_ISP_MultiCamera_Tuning_SetFrontCrop interface series to implement AutoZoom.
 */
int IMP_ISP_MultiCamera_Tuning_SetAutoZoom(IMPVI_NUM num, IMPISPAutoZoom *ispautozoom);

/**
 * @fn IMP_ISP_MultiCamera_Tuning_GetAutoZoom(IMPVI_NUM num, IMPISPAutoZoom *ispautozoom)
 *
 * Get the parameters for autofocus.
 *
 * @param[in] num           the sensor num label.
 * @param[out] ispautozoom  autofocus configuration parameters.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
* @attention Before using this function, we must ensure that IMP_ISP_Tuning_SetAutoZoom is executed and returns success.
* @attention Before using this function, we must ensure that IMP_ISP_EnableSensor is executed and returns success.
 */
int32_t IMP_ISP_MultiCamera_Tuning_GetAutoZoom(IMPVI_NUM num, IMPISPAutoZoom *ispautozoom);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_SetMaskBlock(IMPVI_NUM num, IMPISPMaskBlockAttr *mask)
 *
 * Set Mask Attr.
 *
 * @param[in] num   the sensor num label.
 ...
 * }
 *
 * ret = IMP_ISP_MultiCamera_Tuning_SetMaskBlock(IMPVI_NUM num, &block);
 * if(IMPVI_NUM num, ret){
 * 	IMP_LOG_ERR(IMPVI_NUM num, TAG, "IMP_ISP_MultiCamera_Tuning_SetMaskBlock error !\n");
 * 	return -1;
 * }
 * @endcode
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_SetMaskBlock(IMPVI_NUM num, IMPISPMaskBlockAttr *mask);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_GetMaskBlock(IMPVI_NUM num, IMPISPMaskBlockAttr *mask)
 *
 * Get Fill Parameters..
 *
 * @param[in] num   the sensor num label.
 ...
 * attr.chx = 0;
 * attr.pinum = 0;
 * ret = IMP_ISP_MultiCamera_Tuning_GetMaskBlock(IMPVI_NUM num, &attr);
 * if(IMPVI_NUM num, ret){
 * 	IMP_LOG_ERR(IMPVI_NUM num, TAG, "IMP_ISP_MultiCamera_Tuning_GetMaskBlock error !\n");
 * 	return -1;
 * }
 * printf(IMPVI_NUM num, "chx:%d, pinum:%d, en:%d\n", attr.chx, attr.pinum, attr.mask_en);
 * if (IMPVI_NUM num, attr.mask_en) {
 *      printf(IMPVI_NUM num, "top:%d, left:%d ...\n", ...);
 * }
 * @endcode
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_GetMaskBlock(IMPVI_NUM num, IMPISPMaskBlockAttr *mask);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_SetOSDAttr(IMPVI_NUM num, IMPISPOSDAttr *attr)
 *
 * Set Fill Parameters.
 *
 * @param[in] num   the sensor num label.
 ...
 * IMPISPOSDAttr attr;
 *
 * attr.osd_type = IMP_ISP_MultiCamera_PIC_ARGB_8888;
 * attr.osd_argb_type = IMP_ISP_MultiCamera_ARGB_TYPE_BGRA;
 * attr.osd_pixel_alpha_disable = IMPISP_TUNING_OPS_MODE_ENABLE;
 *
 * if(IMPVI_NUM num, ret){
 * 	IMP_LOG_ERR(IMPVI_NUM num, TAG, " error !\n");
 * 	return -1;
 * }
 * @endcode
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_SetOSDAttr(IMPVI_NUM num, IMPISPOSDAttr *attr);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_GetOSDAttr(IMPVI_NUM num, IMPISPOSDAttr *attr)
 *
 * Get Fill Parameters.
 *
 * @param[in] num   the sensor num label.
 ...
 * IMPISPOSDAttr attr;
 *
 * ret = IMP_ISP_MultiCamera_Tuning_GetOSDAttr(IMPVI_NUM num, &attr);
 * if(IMPVI_NUM num, ret){
 * 	IMP_LOG_ERR(IMPVI_NUM num, TAG, "IMP_ISP_MultiCamera_Tuning_GetOSDAttr error !\n");
 * 	return -1;
 * }
 * printf(IMPVI_NUM num, "type:%d, argb_type:%d, mode:%d\n", attr.osd_type,
 * attr.osd_argb_type, attr.osd_pixel_alpha_disable);
 * @endcode
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_GetOSDAttr(IMPVI_NUM num, IMPISPOSDAttr *attr);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_SetOSDBlock(IMPVI_NUM num, IMPISPOSDBlockAttr *attr)
 *
 * Set osd Attr..
 *
 * @param[in] num   the sensor num label.
 ...
 * block.osd_stride = stride;
 *
 * ret = IMP_ISP_MultiCamera_Tuning_SetOSDBlock(IMPVI_NUM num, &block);
 * if(IMPVI_NUM num, ret){
 * 	imp_log_err(IMPVI_NUM num, tag, "imp_isp_tuning_setosdblock error !\n");
 * 	return -1;
 * }
 * @endcode
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_SetOSDBlock(IMPVI_NUM num, IMPISPOSDBlockAttr *attr);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_GetOSDBlock(IMPVI_NUM num, IMPISPOSDBlockAttr *attr)
 *
 * Get OSDBlock Parameters.
 *
 * @param[in] num   the sensor num label.
 ...
 *
 * attr.pinum = 0;
 * ret = IMP_ISP_MultiCamera_Tuning_GetOSDBlock(IMPVI_NUM num, &attr);
 * if(IMPVI_NUM num, ret){
 * 	IMP_LOG_ERR(IMPVI_NUM num, TAG, "IMP_ISP_MultiCamera_Tuning_GetOSDBlock error !\n");
 * 	return -1;
 * }
 * printf(IMPVI_NUM num, "pinum:%d, en:%d\n", attr.pinum, attr.osd_enable);
 * if (IMPVI_NUM num, attr.osd_enable) {
 *      printf(IMPVI_NUM num, "top:%d, left:%d ...\n", ...);
 * }
 * @endcode
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_GetOSDBlock(IMPVI_NUM num, IMPISPOSDBlockAttr *attr);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_SetDrawBlock(IMPVI_NUM num, IMPISPDrawBlockAttr *attr)
 *
 * Set draw Attr..
 *
 * @param[in] num   the sensor num label.
 ...
 *
 * block.pinum = pinum;
 * block.type = (IMPVI_NUM num, IMPISPDrawType)2;
 * block.color_type = (IMPVI_NUM num, IMPISP_MASK_TYPE)ctype;
 * block.cfg.line.enable = en;
 * block.cfg.line.startx = left / 2 * 2;
 * block.cfg.line.starty = top / 2 * 2;
 * block.cfg.line.endx = w / 2 * 2;
 ...
 * block.cfg.line.width = lw / 2 * 2;
 * block.cfg.line.alpha = alpha;
 * IMP_ISP_MultiCamera_Tuning_SetDrawBlock(IMPVI_NUM num, &block);
 *
 * IMPISPDrawBlockAttr block;
 *
 * block.pinum = pinum;
 * block.type = (IMPVI_NUM num, IMPISPDrawType)0;
 * block.color_type = (IMPVI_NUM num, IMPISP_MASK_TYPE)ctype;
 * block.cfg.wind.enable = en;
 * block.cfg.wind.left = left / 2 * 2;
 * block.cfg.wind.top = top / 2 * 2;
 ...
 *
 * block.pinum = pinum;
 * block.type = (IMPVI_NUM num, IMPISPDrawType)1;
 * block.color_type = (IMPVI_NUM num, IMPISP_MASK_TYPE)ctype;
 * block.cfg.rang.enable = en;
 * block.cfg.rang.left = left / 2 * 2;
 * block.cfg.rang.top = top / 2 * 2;
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_SetDrawBlock(IMPVI_NUM num, IMPISPDrawBlockAttr *attr);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_GetDrawBlock(IMPVI_NUM num, IMPISPDrawBlockAttr *attr)
 *
 * Get draw Attr..
 *
 * @param[in] num   the sensor num label.
 ...
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t IMP_ISP_MultiCamera_Tuning_GetDrawBlock(IMPVI_NUM num, IMPISPDrawBlockAttr *attr);

/**
 * @fn int32_t  IMP_ISP_MultiCamera_Tuning_SwitchBin(IMPVI_NUM num, IMPISPBinAttr *attr)
 *
 * Switch Bin files.
 *
 * @param[in] num    the sensor num label.
 * @param[out] attr  bin file attributes to toggle
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 */
int32_t  IMP_ISP_MultiCamera_Tuning_SwitchBin(IMPVI_NUM num, IMPISPBinAttr *attr);

typedef struct {
        unsigned short switch_gpio; /* Dual camera MIPI SWITH control GPIO */
        uint16_t Msensor_gstate; /* Main camera MIPI SWITH GPIO STATE */
        uint16_t Ssensor_gstate; /* Second camera MIPI SWITH GPIO STATE */
} IMPDoubleSensor;

typedef struct {
        unsigned short switch_gpio[2]; /* Triple camera MIPI SWITCH double control GPIO */
        uint16_t Msensor_gstate[2]; /* Main camera MIPI SWITCH double control GPIO STATE */
        uint16_t Ssensor_gstate[2]; /* Second camera MIPI SWITCH double control GPIO STATE */
        uint16_t Tsensor_gstate[2]; /* Triple camera MIPI SWITCH double control GPIO STATE */
} IMPTrebleSensor;

typedef struct {
        uint16_t enable;  /* Enable user customization MIPI SWITCH control GPIO */
        uint16_t sensornum; /* sensor number */
        union {
...
/**
 * @fn int32_t IMP_ISP_MultiCamera_SetSwitchgpio(IMPUserSwitchgpio *info)
 *
 * User set MIPI SWITCH to control GPIO.
 *
 * @param[in] info  CPIO info.
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using this function, "IMP_ISP_Open" had already been called and "IMP_ISP_AddSensor" had not been called.
 */
int32_t IMP_ISP_MultiCamera_SetSwitchgpio(IMPUserSwitchgpio *info);

typedef enum{
	IMPISP_NOT_JOINT = 0,                  /**< The splicing mode is not enabled for dual shots */

    //fs0 is spliced with fs3
	IMPISP_03_ON_THE_LEFT,               /**< Double shot enables the splicing mode, with the main shot image on the left */
	IMPISP_03_ON_THE_RIGHT,              /**< Dual shot enables the splicing mode, with the main shot image on the right */
	IMPISP_03_ON_THE_ABOVE,              /**< Double shot enables the splicing mode with the main shot image at the top */
	IMPISP_03_ON_THE_UNDER,              /**< Double shot enables the splicing mode with the main shot image at the bottom */

    //fs1 is spliced with fs4
	IMPISP_14_ON_THE_LEFT,              /**< Double shot enables the splicing mode, with the main shot image on the left */
	IMPISP_14_ON_THE_RIGHT,             /**< Dual shot enables the splicing mode, with the main shot image on the right */
	IMPISP_14_ON_THE_ABOVE,             /**< Double shot enables the splicing mode with the main shot image at the top */
	IMPISP_14_ON_THE_UNDER,             /**< Double shot enables the splicing mode with the main shot image at the bottom */

    //f0 is spliced with f1 and fs3 with fs4
	IMPISP_03_14_ON_THE_LEFT =  0x15,    /**< Double shot enables the splicing mode, with the main shot image on the left */
	IMPISP_03_14_ON_THE_RIGHT = 0x26,   /**< Dual shot enables the splicing mode, with the main shot image on the right */
	IMPISP_03_14_ON_THE_ABOVE = 0x37,   /**< Double shot enables the splicing mode with the main shot image at the top */
	IMPISP_03_14_ON_THE_UNDER = 0x48,   /**< Double shot enables the splicing mode with the main shot image at the bottom */

	IMPISP_MAIN_JOINT_BUTT,                /**< effect paramater, parameters have to be less than this value */
} IMPISPDualSensorSplitJoint;

/**
* Parameter structure of multicamera system
*/
typedef struct  {
	IMPISPDualSensorSplitJoint joint_mode;        /**< Selection of splicing mode for double shot images */
	uint16_t outstride[2];        /*[0]: main stream f0 f3 splicing span [1]: secondary stream f1 f4 splicing span */
} IMPISPCameraInputMode;

/**
 * @fn int32_t IMP_ISP_SetCameraInputMode(IMPISPDualSensorSplitJoint *mode)
 *
 * Set the parameters of the multicamera system
 * This API can only be used for concatenation if it is not pass-through
 *
 * @retval 0 success
 * @retval Non-0 failure, error code returned
 *
 * @attention This function must be called before the sensors are added, that is, the function is called first and then IMP_ISP_AddSensor is called to add sensors one by one
 */
int32_t IMP_ISP_SetCameraInputMode(IMPISPCameraInputMode *mode);

/**
 * @fn int32_t IMP_ISP_MultiCamera_Tuning_AwbSync(IMPVI_NUM num, unsigned int sync_flag)
 *
 * Set the camera AWB parameters to align with the main camera.
 *
 * @param[in] num   the sensor num label.
 * @param[in] sync_flag Whether to enable the alignment function (1 for enabled, 0 for disabled).
 *
 * @retval 0 means success.
 * @retval Non-0 failure, error code returned
 *
 * @attention Before using it, make sure that 'IMP_ISP_EnableTuning' is working properly.
 * @attention The field of view of the cameras should have overlapping parts and be as similar as possible. They cannot be used under different color temperatures.
 */
int32_t IMP_ISP_MultiCamera_Tuning_AwbSync(IMPVI_NUM num, unsigned int sync_flag);
